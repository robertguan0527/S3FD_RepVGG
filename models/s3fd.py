...
class S3FD(nn.Module):
    ...
    def __init__(self, phase, base, extras, head, num_classes):
        ...
        self.L2Norm3_3 = L2Norm(64, 10)
        self.L2Norm4_3 = L2Norm(128, 8)
        self.L2Norm5_3 = L2Norm(256, 5)
...
def multibox(vgg, extra_layers, num_classes):
    ...
    loc_layers += [nn.Conv2d(1280, 4,
                             kernel_size=3, padding=1)]
    conf_layers += [nn.Conv2d(1280,
                              num_classes, kernel_size=3, padding=1)]
...
def build_s3fd_repvgg(phase, num_classes=2,deploy =False):
    base_, extras_, head_ = multibox(
        RepVgg('RepVGG-A1', deploy), add_extras((extras_cfg), 1280), num_classes)
