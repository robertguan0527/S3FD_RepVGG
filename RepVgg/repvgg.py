...
class RepVGGBlock(nn.Module):
    ...
    def forward(self, inputs):
        ...
        output = self.nonlinearity(self.se(self.rbr_dense(inputs) + self.rbr_1x1(inputs) + id_out))
...
class RepVGG(nn.Module):
    # (num_blocks=[2, 4, 14, 1], num_classes=1000,
    ...
    def __init__(self, num_blocks, num_classes=1000, width_multiplier=None, override_groups_map=None, deploy=False, use_se=False):
        ...
        self.in_planes = min(64, int(64 * width_multiplier[0]))#48
